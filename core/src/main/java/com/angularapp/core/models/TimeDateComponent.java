...
/**
 * Defines the {@code TimeDateComponent} Sling Model used for the {@code angularapp/components/time-date-component} component.
 * 
 */
@ConsumerType
public interface TimeDateComponent
