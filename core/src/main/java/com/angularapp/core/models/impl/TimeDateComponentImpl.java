...
import com.angularapp.core.models.TimeDateComponent;
...
@Model(adaptables = {
    ...
    TimeDateComponent.class,
    ComponentExporter.class
}, resourceType = "angularapp/components/time-date-component")
@Exporter(name = ExporterConstants.SLING_MODEL_EXPORTER_NAME, extensions = ExporterConstants.SLING_MODEL_EXTENSION)
public class TimeDateComponentImpl
    implements TimeDateComponent
{
