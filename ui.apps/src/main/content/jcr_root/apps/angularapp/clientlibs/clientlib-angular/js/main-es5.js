...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_footer_home_footer_home_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(
  ...
  function srcAppComponentsButtonButtonComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ButtonComponent = /*#__PURE__*/function () {
      ...
      _createClass(ButtonComponent, [{
        ...
        key: "loginValues",
        value: function loginValues() {
          var isChecked = this.localStorageService.get('username') && this.localStorageService.get('password') && this.localStorageService.get('username') === 'admin' && this.localStorageService.get('password') === 'admin' ? true : false;
          return isChecked;
        }
      }]);
